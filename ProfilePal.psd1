...
FileList = @('AdminConsole.ps1', 'copy-module.ps1', 'ProfilePal.psd1', 'ProfilePal.psm1', 'Show-MsgBox.ps1', 'toolbox.ps1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Updated usability of Suspend-Profile. Broke some functions out into their own module files. Fixed -NoProfile behavior of Open-AdminConsole function.'
